   ...
   public void getTradingDatesAndReadTillStartTime()throws Exception{
    ...
    public void applyStrategy(){
        ...
        do {
            ...
            strategyImpls.stream().forEach(strategyImpl -> {
...
//                System.out.println(date+" "+dayMetric.profitPercentWithCost.profit +" "+cumulativeNetProfitPercent
//                		+" "+maxCumulativeProfitPercent+" "+drawDownPercent+" "+maxDrawDownPercentage);

                netProfitPercent += dayMetric.profitPercentWithCost.profit;
            }
            metricInfo.overAllMetric.calmar = netProfitPercent/maxDrawDownPercentage;
