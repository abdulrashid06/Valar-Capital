...
public class Strategy {
    ...
    public Strategy(boolean positional,List<KeyValues> runForKeyAttribs){
   ...
   public void getTradingDatesAndReadTillStartTime()throws Exception{
    ...
    public void applyStrategy(){
        Ohlc indexOhlc = indexState.ohlc;
        ...
        do {
            ...
            if(indexOhlc.time.equalsIgnoreCase("15:29")) {
...
//        });
    ...
    public void apply()throws Exception{
        indexState = new IndexState(indexFile,indexFile,0,dateTimeFormat,true);
