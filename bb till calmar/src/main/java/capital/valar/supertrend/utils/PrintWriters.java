...
public class PrintWriters {
    ...
    public static void loadAllWriters()throws Exception{
        ...
        overAllPrintWriter.write(ValarTrade.keystoreHeading+",TradingDays,TotalTrades,TradeMaxProfit,TradeMaxLoss" +
        	    ...
        	    ",DayAverageProfit,DayAverageLoss,DayWinPercent,DayExpectancy,Profit(Cost),Profiercent(Cost),DayWinPercent(Cost)" +
        	    ",DayAverageProfit(Cost),DayAverageLoss(Cost),DayExpectancy(Cost),AvgHoldingPeriod,Calmar\n");
