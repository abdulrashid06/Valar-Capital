...
public class PrintWriters {
    ...
    public static void loadAllWriters()throws Exception{
        ...
        orderInfoPrintWriter.write("S.no,Date,TradeType,TradeId,HoldingPeriod,EntryTime,EntryPrice,ExitTime,ExitPrice,Reason,Profit,Profit%,ProfitCost,ProfitCost%,DayATR,UpperBand,LowerBand,SMA,BandRangePercent,BandChangePercent,\n");
        ...
        overAllPrintWriter.write(ValarTrade.keystoreHeading+",TradingDays,TotalTrades,TradeMaxProfit,TradeMaxLoss" +
        	    ",DayMaxProfit,DayMaxLoss,TradeAverageProfit,TradeAverageLoss,TradeWinPercent,TradeExpectancy,TradeExpectancy(Cost),Profit" +
        	    ",DayAverageProfit,DayAverageLoss,DayWinPercent,DayExpectancy,Profit(Cost),DayWinPercent(Cost)" +
        	    ",DayAverageProfit(Cost),DayAverageLoss(Cost),DayExpectancy(Cost),AvgHoldingPeriod,\n");
