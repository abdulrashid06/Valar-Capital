...
public class TradeMetric {
    ...
    public float profit, profitPercent, profitPercentBn, profitCost;
...
//        this.profitWithCost += printAttribs.profitCost;
        ...
        orderInfo.write(kv.sno+","+entryOhlc.date+","+kv.tradeType+","+id+","+holdingPeriod+"," +entryOhlc.dnt+","+entryOhlc.close
