...
public class KeyValues {
	...
	public int sno, BnOrN, startTime, cutOffTime, endTime, candlePeriod;
    ...
    public KeyValues(String ln) {
        ...
        iter = 0;
//        System.out.println(iter + "   "+splits.length);
    ...
    public String toString() {
    	return "KeyValues [sno=" + sno + ", tradeType=" + tradeType+ ", positional=" + positional + ", BnOrN=" + BnOrN + ", startTime="
				+ startTime + ", cutOffTime=" + cutOffTime + ", endTime=" + endTime + ", candlePeriod=" + candlePeriod+ ", period=" + period + ", sd="
